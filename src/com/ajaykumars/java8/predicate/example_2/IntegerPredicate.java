...
public class IntegerPredicate {
    ...
    public static Predicate<Integer> negativeIntegerPredicate() {return number -> number > 0; };

    // Predicate with Args
    public static Predicate<Integer> getExactIntegerPredicate(Integer numberToFind){ return number -> number == numberToFind;};
